...
/**
 * ================================================
 * API: إرسال الاتصالات (إيميلات احترافية)
 * ================================================
 * الهدف: إرسال إيميلات الموافقة/الرفض/التفعيل باستخدام PHPMailer
 * الاستخدام: يُستدعى من manage_enrollments و manage_finance
 * ================================================
 */
